...
DataMapper is deprecated as of Mule runtime 3.7.0 and it is completely removed in Mule 4.0 and superseded by the xref:transform-message-component-concept-studio.adoc[Transform Message Component].
